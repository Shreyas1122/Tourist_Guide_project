...
class france {
    ...
    void france_cities() {
        ...
        try {
            ...
            String query = "Select * from france_city";
...
class germany{
    ...
    void germany_cities() {
        ...
        try {
            Connection conn = DriverManager.getConnection(url, username, password);
            String query = "Select * from germany_city";
            Statement state = conn.createStatement();
            ResultSet result = state.executeQuery(query);
            List<String> city = new ArrayList<String>();
            List<Double> population = new ArrayList<Double>();
...
class italy{
    ...
    void italy_cities() {
        ...
        try {
            Connection conn = DriverManager.getConnection(url, username, password);
            String query = "Select * from italy_city";
            Statement state = conn.createStatement();
            ResultSet result = state.executeQuery(query);
            List<String> city = new ArrayList<String>();
            List<Double> population = new ArrayList<Double>();
...
class uk{
    ...
    void uk_cities() {
        ...
        try {
            Connection conn = DriverManager.getConnection(url, username, password);
            String query = "Select * from uk_city";
            Statement state = conn.createStatement();
            ResultSet result = state.executeQuery(query);
            List<String> city = new ArrayList<String>();
            List<Double> population = new ArrayList<Double>();
...
class switzerland{
    ...
    void switzerland_cities() {
        ...
        try {
            Connection conn = DriverManager.getConnection(url, username, password);
            String query = "Select * from switzerland_city";
            Statement state = conn.createStatement();
            ResultSet result = state.executeQuery(query);
            List<String> city = new ArrayList<String>();
            List<Double> population = new ArrayList<Double>();
